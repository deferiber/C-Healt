        ...
        <div class="grid gap-4 md:grid-cols-2 md:gap-8 xl:gap-20 md:items-center">
            <div>
                <h3
                    ...
                    Kenali ciri, gejala, penularan, resiko, terapi arv HIV/AIDS di <span class="text-blue-600">C-Healt
                        Apps</span>
                </h3>
                <p class="mt-3 text-lg text-gray-800 dark:text-neutral-400">
                    Selamatkan diri dan keluarga Anda. Lebih baik mencegah daripada mengobati. Unduh sekarang!</p>
