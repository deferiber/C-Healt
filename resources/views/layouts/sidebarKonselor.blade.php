...
<div id="application-sidebar" class="hs-overlay [--auto-close:lg]
    ...
    <nav class="flex flex-col flex-wrap w-full p-6 hs-accordion-group" data-hs-accordion-always-open>
        <ul class="space-y-1.5">
            <li>
                <x-nav-link :href="route('konselor.dashboard')" :active="request()->routeIs('konselor.dashboard')">
                    <svg class="flex-shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        stroke-linejoin="round">
            ...
            <li>
                <x-nav-link :href="route('konselor.dashboard')" :active="request()->routeIs(['konselor.editUser'])">
                    <svg class="flex-shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        stroke-linejoin="round">
