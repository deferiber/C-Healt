                ...
                <div class="-m-1.5 overflow-x-auto">
                    <div class="p-1.5 min-w-full inline-block align-middle">
                        <div
                            ...
                            <!-- Header -->
                            <div class="flex items-center px-8 py-4 mb-4 gap-x-4 first:pt-4 last:pb-4">
                                <div class="inline-flex gap-x-2">
                                    <a href="{{ route('labcvts.create') }}"
                            ...
                            <table class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
                                ...
                                <tbody class="divide-y divide-gray-200 dark:divide-neutral-700">
                                    @foreach ($datalabcvt as $index => $row )
                                    <tr>
                                        <td class="w-8 h-px whitespace-nowrap">
                                            <div class="px-6 py-3">
                                                <span
                                                    class="block text-sm font-semibold text-gray-800 dark:text-neutral-200">
                                                    {{ $index+$datalabcvt->firstItem() }}
                                                </span>
                                            </div>
                                        </td>
                                        ...
                                        <td class="size-px whitespace-nowrap">
                                            <div class="px-6 py-1.5 flex gap-3">
                                                {{-- <a
                                                    ...
                                                    href="{{ route('datalabcvt.edit', $row->id) }}">
                                                    Edit
                                                </a> --}}
                                                {{-- <form onsubmit="return confirm('Anda yakin menghapus data ini?')"
                                                    method="post" action="{{ route('datalabcvt.destroy', $row->id) }}">
                                                    @method('DELETE')
                                                    @csrf
                                                    <button
                                                        class="inline-flex items-center text-sm font-medium text-blue-600 gap-x-1 decoration-2 hover:underline dark:text-blue-500">
                                ...
                                <div>
                                    <p class="text-sm text-gray-600 dark:text-neutral-400">
                                        <span class="font-semibold text-gray-800 dark:text-neutral-200">
                                            {{ $datalabcvt->links('pagination::tailwind') }}
                                        </span>
                                    </p>
                                </div>
